      ...
      <div className={styles.page}>
        ...
        <main className={styles.container}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            <svg viewBox="0 0 24 24" fill="none" stroke="#e83e8c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: '40px', height: '40px' }}>
            ...
            <h1 className={styles.title} style={{ margin: 0, fontSize: '2rem' }}>Patient History</h1>
          </div>
          <p style={{ color: '#666', marginBottom: '24px' }}>Search and select a patient to view their complete medical history.</p>
          <input 
            type="text" 
    ...
    <div className={styles.page}>
      ...
      <main className={styles.container}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
          <svg viewBox="0 0 24 24" fill="none" stroke="#e83e8c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: '32px', height: '32px' }}>
            <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/>
            <rect x="8" y="2" width="8" height="4" rx="1" ry="1"/>
            <circle cx="16" cy="16" r="5"/>
            <path d="M16 14v2l1.5 1.5"/>
          ...
          <h1 className={styles.title} style={{ margin: 0 }}>Patient History – {patient.name}</h1>
        </div>
